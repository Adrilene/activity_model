...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Gen Code Style</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see genmodel.GenmodelPackage#getGenCodeStyle()
 * @model
 * @generated
 */
public enum GenCodeStyle implements Enumerator {
	 ...
	 * @generated
	 */
	private static final GenCodeStyle[] VALUES_ARRAY = new GenCodeStyle[] { UNNECESSARY_ELSE,
			SWITCH_MISSING_DEFAULT_CASE, UNNECESSARY_ASSIGNMENT_BEFORE_RETURN, UNNECESSARY_DEPRECATED_METHOD, };
	...
	public static GenCodeStyle get(int value) {
		switch (value) {
		case UNNECESSARY_ELSE_VALUE:
			return UNNECESSARY_ELSE;
		case SWITCH_MISSING_DEFAULT_CASE_VALUE:
			return SWITCH_MISSING_DEFAULT_CASE;
		case UNNECESSARY_ASSIGNMENT_BEFORE_RETURN_VALUE:
			return UNNECESSARY_ASSIGNMENT_BEFORE_RETURN;
		case UNNECESSARY_DEPRECATED_METHOD_VALUE:
