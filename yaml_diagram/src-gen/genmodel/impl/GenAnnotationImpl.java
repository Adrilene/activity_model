 ...
 * </p>
 * <ul>
 *   <li>{@link genmodel.impl.GenAnnotationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link genmodel.impl.GenAnnotationImpl#getDetails <em>Details</em>}</li>
 *   <li>{@link genmodel.impl.GenAnnotationImpl#getGenBase <em>Gen Base</em>}</li>
 *   <li>{@link genmodel.impl.GenAnnotationImpl#getReferences <em>References</em>}</li>
 *   <li>{@link genmodel.impl.GenAnnotationImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenAnnotationImpl extends GenBaseImpl implements GenAnnotation {
	...
	public void setSource(String newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenmodelPackage.GEN_ANNOTATION__SOURCE, oldSource,
					source));
	}
	...
	public EMap<String, String> getDetails() {
		if (details == null) {
			details = new EcoreEMap<String, String>(EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY,
					EStringToStringMapEntryImpl.class, this, GenmodelPackage.GEN_ANNOTATION__DETAILS);
		}
		return details;
	}
	...
	public GenBase getGenBase() {
		if (eContainerFeatureID() != GenmodelPackage.GEN_ANNOTATION__GEN_BASE)
			return null;
	...
	public void setGenBase(GenBase newGenBase) {
		if (newGenBase != eInternalContainer()
				|| (eContainerFeatureID() != GenmodelPackage.GEN_ANNOTATION__GEN_BASE && newGenBase != null)) {
			...
			if (newGenBase != null)
				msgs = ((InternalEObject) newGenBase).eInverseAdd(this, GenmodelPackage.GEN_BASE__GEN_ANNOTATIONS,
						GenBase.class, msgs);
			msgs = basicSetGenBase(newGenBase, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GenmodelPackage.GEN_ANNOTATION__GEN_BASE, newGenBase,
					newGenBase));
	}
	...
	public EList<EObject> getReferences() {
		if (references == null) {
			references = new EObjectResolvingEList<EObject>(EObject.class, this,
					GenmodelPackage.GEN_ANNOTATION__REFERENCES);
		}
		return references;
	}
	...
	public EList<EObject> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<EObject>(EObject.class, this,
					GenmodelPackage.GEN_ANNOTATION__CONTENTS);
		}
		return contents;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case GenmodelPackage.GEN_ANNOTATION__GEN_BASE:
			return eInternalContainer().eInverseRemove(this, GenmodelPackage.GEN_BASE__GEN_ANNOTATIONS, GenBase.class,
					msgs);
		}
